...
losers bracket automatically. Supports **7, 8, or 9 teams**, chosen day-of.
...
1. **/setup** — pick 7/8/9 teams, edit names, order them by seed (arrows or Shuffle),
...
- `src/lib/bracket.ts` — the double-elim templates for 7/8/9 and the pure
